    ...
    [ 
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    dcc.Dropdown(
                        ['Borrowed', 'Returned','Assigned','Misplaced','Returned','Condemned'], 'Borrowed',
                        id='propprof_stat',
                        clearable=True,
                    ),
                    width=6,
        ...
        dbc.Row(
            [
                ...
                dbc.RadioItems(
                    options=[
                        {"label": "Personal PAR", "value": "Personal"},
                        {"label": "Mother PAR", "value": "Mother"},
                    ],
                    value=1,
...
def propprof_submitprocess(submitbtn, closebtn,
                                desc, qty, unit, purch_date, purch_amt, total_purch_amt, employee_id, stat, category, remarks, receipt_file, receipt_name, search, removerecord, location, par_type):
    print("Search:", search)
